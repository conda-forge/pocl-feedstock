...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/pocl-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pocl-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add pocl pocl-core pocl-cpu pocl-cpu-minimal pocl-cuda pocl-remote
# for installing globally
pixi global install pocl pocl-core pocl-cpu pocl-cpu-minimal pocl-cuda pocl-remote
```
...
It is possible to list all of the versions of `pocl` available on your platform:
...
```
pixi search pocl --channel conda-forge
```
